          ...
          <div className="grid grid-cols-2 gap-6 lg:gap-8 max-w-2xl">
            {languages.map((lang, idx) => (
              <motion.div
                ...
                variants={cardVariants}
                whileTap={{ scale: 0.95 }}
                className="relative group overflow-hidden bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 hover:border-blue-500/50 dark:hover:border-blue-400/50 px-6 py-8 rounded-2xl shadow-lg text-center transition-all duration-300"
              >
                {/* Background Gradient */}
        ...
        {[...Array(6)].map((_, i) => (
          <motion.div
            ...
            className={`absolute w-2 h-2 rounded-full ${
              i % 3 === 0 ? 'bg-blue-400/20 dark:bg-blue-300/10' :
